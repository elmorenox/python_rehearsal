...
# this is reccomended over looping over a list of all processes
...
for proc in ps.process_iter():
    ...
    # override cpu percent value to store the current cpu percet at a given time
...
# pass the porcesses list to the csv writer using dictionary writer
